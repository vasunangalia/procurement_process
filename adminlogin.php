  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="scroll active"><a href="#"><span class="glyphicon glyphicon-user"></span>Admin Login</a></li>
		<li class="scroll"><a href="coordinatorlogin.php"><span class="glyphicon glyphicon-user"></span>Coordinator Login</a></li>
			...
			<div class="col-sm-6 col-md-4 col-md-offset-4">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form role="form" name="form1" action="loginverify.php"  onsubmit="return validate()" method="post" >
							<fieldset>
								<div class="row">
									...
									<div class="col-sm-12 col-md-10  col-md-offset-1 ">
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" placeholder="Admin Id" name="username" type="text" autofocus>
											</div>
										</div>
										<div class="form-group">
											<div class="input-group">
