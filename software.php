...
.profile-img {
	...
	<h2 align="center" style="color:slategray;font-family:calibri"><strong>Procument Process</strong></h2></span></div>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="scroll"><a href="adminentry.php"><span class="glyphicon glyphicon-user"></span>Hardware Details Entry</a></li>
        <li class="scroll active"><a href="software.php"><span class="glyphicon glyphicon-user"></span>Software Details Entry</a></li>
									...
									<div class="col-sm-12 col-md-10  col-md-offset-1 ">
                                        ...
                                        <div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" placeholder="License" name="license" type="text" value="">
											</div>
										</div>
                                         <div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" placeholder="Version" name="version" type="text" value="">
											</div>
										</div>
										<div class="form-group">
											<div class="input-group">
...
$in = "INSERT INTO software (id,name,license,version,estcost) VALUES ('$id','$name','$license','$version','$cost') 
ON DUPLICATE KEY UPDATE name=values(name), id=values(id), license=values(license),version=values(version),estcost=values(estcost)";
$inst = mysqli_query($conc,$in);

if($in)
{
	echo "<html><body><p><b>Software data entered</b></p></body></html>";
}
else
{
